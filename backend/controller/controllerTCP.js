    ...
    async index(request, response) {
        ...
        */
        ...
        var oids = [
            ...
            var nameIOD = [
                "tempo limite retransmição de octetos não reconhecidos",
                "valor mínimo para tempo limite de retransmissão",
                "valor máximo para tempo limite de retransmissão",
                "número total de conexões TCP que a entidade pode suportar",
                "N° de transição direta estado SYN-SENT do estado CLOSED",
                "N° de transição direta estado SYN-RCVD do estado LISTEN",
                "tcpAttemptFails",
            ];
